...
for i, path in enumerate(path_list):
    csv_url = path
    country_tech_url = csv_url.partition('/gpfs/home/schiu4/segmented_data_patent_decile/')[2].partition('/')[2].partition('.')[0]
    country = csv_url.partition('/gpfs/home/schiu4/segmented_data_patent_decile/')[2].partition('/')[2].partition('-')[0]
    tech = csv_url.partition('/gpfs/home/schiu4/segmented_data_patent_decile/')[2].partition('/')[2].partition('-')[2].partition('.')[0]
