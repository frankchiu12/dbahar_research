# this scripts segements the data by patents in the decile we want into files of country-tech
...
for country in df.inventor_iso2.unique():
    ...
    for tech in sub_df.cpc_id.unique():
        ...
        # find all of the patents in that decile
        patents_to_consider = sub_sub_df[sub_sub_df.pt_patents_10 == decile].patent_id.unique()
        # make a df called cut_df that has data for patents in the decile
